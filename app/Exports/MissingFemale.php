...
class MissingFemale implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, WithStyles
{
    ...
    */
    ...
    {
        $this->data->whereNull('households.number_of_female');
