...
class EnergyHouseWiring implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    public function collection()
    {
        $houseWiring = DB::table('energy_system_wiring_houses')
            ...
            ->select(
                ...
                'energy_system_wiring_houses.unit',
                DB::raw('(energy_system_wiring_houses.cost / energy_system_wiring_houses.unit) as cost_per_unit'),
                'energy_system_wiring_houses.cost'
            )
            ->get();

        $totals = $houseWiring->reduce(function ($carry, $item) {
