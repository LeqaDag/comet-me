...
class EnergyBts implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    public function collection()
    {
        $bts = DB::table('energy_system_battery_temperature_sensors')
            ...
            ->select(
                ...
                'energy_system_battery_temperature_sensors.bts_units',
        ...
        $totals = $bts->reduce(function ($carry, $item) {
            $carry['bts_units'] += $item->bts_units;
