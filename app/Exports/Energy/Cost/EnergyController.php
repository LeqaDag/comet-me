...
class EnergyController implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    public function collection()
    {
        $controllers = DB::table('energy_system_charge_controllers')
            ...
            ->select(
                ...
                'energy_system_charge_controllers.cost'
            )
            ->get(); 


        $totals = $controllers->reduce(function ($carry, $item) {
            $carry['controller_units'] += $item->controller_units;
        ...
        $controllers->push([
            'name' => 'Total',
            'model' => '',
            'controller_units' => $totals['controller_units'],
