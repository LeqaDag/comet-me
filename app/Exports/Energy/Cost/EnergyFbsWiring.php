...
class EnergyFbsWiring implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    public function collection()
    {
        $fbsWiring = DB::table('energy_system_fbs_wirings')
            ...
            ->select(
                ...
                'energy_system_fbs_wirings.unit',
                DB::raw('(energy_system_fbs_wirings.cost / energy_system_fbs_wirings.unit) as cost_per_unit'),
               'energy_system_fbs_wirings.cost'
            )
            ->get(); 

        $totals = $fbsWiring->reduce(function ($carry, $item) {
