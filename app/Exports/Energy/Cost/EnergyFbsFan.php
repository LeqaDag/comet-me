...
class EnergyFbsFan implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    public function collection()
    {
        $fbsFan = DB::table('energy_system_fbs_fans')
            ...
            ->select(
                ...
                'energy_system_fbs_fans.unit',
                DB::raw('(energy_system_fbs_fans.cost / energy_system_fbs_fans.unit) as cost_per_unit'),
                'energy_system_fbs_fans.cost'
            )
            ->get();

        $totals = $fbsFan->reduce(function ($carry, $item) {
