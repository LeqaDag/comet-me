    ...
    */
    public function collection()  
    {
        $query = DB::table('energy_systems')
            ...
            ->LeftJoin('energy_system_monitorings', 'energy_systems.id', '=', 
                'energy_system_monitorings.energy_system_id')
            ...
            ->select(
                'energy_systems.name', 
                'energy_monitorings.monitoring_model', 'energy_system_monitorings.monitoring_units'
            );
    ...
    {
        return ["Energy System", "Logger Model", "Logger Units"
        ];
    }
