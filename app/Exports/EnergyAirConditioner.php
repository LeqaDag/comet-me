    ...
    */
    public function collection()  
    {
        $query = DB::table('energy_systems')
            ...
            ->LeftJoin('energy_system_air_conditioners', 'energy_systems.id', '=', 
                'energy_system_air_conditioners.energy_system_id')
            ...
            ->select(
                'energy_systems.name', 
                'energy_air_conditioners.model', 'energy_system_air_conditioners.energy_air_conditioner_units',
            );
    ...
    {
        return ["Energy System", "Air Conditioner Model", "Air Conditioner Units"
        ];
    }
