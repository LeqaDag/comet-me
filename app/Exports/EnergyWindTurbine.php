...
class EnergyWindTurbine implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    */
    public function collection()  
    {
        $query = DB::table('energy_systems')
            ...
            ->LeftJoin('energy_system_wind_turbines', 'energy_systems.id', '=', 
                'energy_system_wind_turbines.energy_system_id')
    ...
    {
        return ["Energy System", "Wind Turbine Model", "Wind Turbine Units"
        ];
    }
