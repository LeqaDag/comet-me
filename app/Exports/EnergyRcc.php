...
class EnergyRcc implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    */
    public function collection()  
    {
        $query = DB::table('energy_systems')
            ...
            ->LeftJoin('energy_system_remote_control_centers', 'energy_systems.id', '=', 
                'energy_system_remote_control_centers.energy_system_id')
    ...
    {
        return ["Energy System", "RCC Model", "RCC Units"
        ];
    }
