...
class EnergyMcbInventer implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, 
    ...
    */
    public function collection()  
    {
        $query = DB::table('energy_systems')
            ...
            ->LeftJoin('energy_system_mcb_inverters', 'energy_systems.id', '=', 
                'energy_system_mcb_inverters.energy_system_id')
            ...
            ->select(
                'energy_systems.name', 
                'energy_mcb_inverters.inverter_MCB_model', 'energy_system_mcb_inverters.mcb_inverter_units',
            );
    ...
    {
        return ["Energy System", "MCB Inventer Model", "MCB Inventer Units"
        ];
    }
