...
class DonorInternet implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize, WithStyles
{
        ...
        $data =  DB::table('internet_users')
            ...
            ->select(
                ...
                DB::raw('COUNT(DISTINCT CASE WHEN households.id IS NOT NULL THEN 
                    internet_users.id END) as served_households'),
                ...
                DB::raw('COUNT(DISTINCT CASE WHEN public_structures.id IS NOT NULL 
                    THEN internet_users.id END) as served_public_structures'),
