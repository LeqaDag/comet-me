...
class GridLargeHolders implements FromCollection, WithHeadings, WithTitle, ShouldAutoSize,
    ...
    */
    public function collection()
    {
        $data = DB::table('all_water_holders') 
            ...
            ->select([ 
                ...
                'grid_users.grid_integration_large', 'grid_users.large_date', 
    ...
    public function headings(): array
    {
        return ["Water Holder", "Main Holder", "Community", "Region", 
            "Sub Region", "Grid Integration Large Number", "Installation date (Grid Large)", 
    ...
    {
        return 'Grid Integration Large Holders';
    }
}