        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row) {
                    ...
                    $updateButton = "<a type='button' class='updateEnergyMaintenance' data-id='".$row->id."' data-bs-toggle='modal' data-bs-target='#updateMaintenanceModal' ><i class='fa-solid fa-pen-to-square text-success'></i></a>";
