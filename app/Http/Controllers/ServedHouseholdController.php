...
class ServedHouseholdController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('employee.household.served.edit', compact('household', 'regions', 'communities',
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/served-household')
            ->with('message', 'Served Household Updated Successfully!');
    }
