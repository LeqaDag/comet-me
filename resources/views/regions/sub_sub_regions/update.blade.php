<div id="updateSubSubRegionModal"class="modal fade" tabindex="-1" aria-hidden="true" 
        role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <fieldset class="form-group">
                            <label class='col-md-12 control-label' for="region_id">Sub Region</label>
                            <select id='updateSubRegionId' class="updateSubRegionId form-control">
                                <option id="selectedSubRegion" selected></option>
                            </select> 
                        </fieldset>  
                    </div>
                </div> -->
                ...
                <input type="text" id="selectedSubRegionValue" hidden>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default btn-sm" 
                    data-bs-dismiss="modal" id="closeSubSubRegionUpdate">Close
                </button>
            </div>
        </div>
