...
<div id="updateElectricityGridCompound{{$compoundsElecticityRoom->id}}" class="modal fade" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <fieldset class="form-group">
                                ...
                                <select name="grid" class="form-control">
                                    <option disabled selected>{{$compoundsElecticityRoom->grid}}</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </fieldset>
