...
<div id="viewWaterIncidentModal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">
                    <span id="waterIncidentModalTitle"></span> Details
                </h1>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h6>
                            Energy User: 
                            <span class="spanDetails" id="waterUser">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h6>
                            Water Incident Status: 
                            <span class="spanDetails" id="waterIncidentStatus">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h6>
                            Equipment: 
                            <span class="spanDetails" id="incidentEquipment">
