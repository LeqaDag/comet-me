<div id="affectedWaterHouseholdModal" class="modal fade" tabindex="-1" aria-hidden="true" 
    aria-labelledby="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    @if (count($allWaterIncident->affectedHouseholds))
                        <table class="table table-striped">
                            ...
                            <tbody>
                            @foreach($allWaterIncident->affectedHouseholds as $affectedHousehold)
                                <tr> 
