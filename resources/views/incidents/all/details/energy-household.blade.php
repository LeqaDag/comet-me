<div id="affectedEnergyHouseholdModal" class="modal fade" tabindex="-1" aria-hidden="true" 
    aria-labelledby="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    @if (count($allEnergyIncident->affectedHouseholds))
                        <table class="table table-striped">
                            ...
                            <tbody>
                            @foreach($allEnergyIncident->affectedHouseholds as $affectedHousehold)
                                <tr> 
