...
<div id="createMaintenanceLogNewElectricity" class="modal fade" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype='multipart/form-data' 
                    action="{{url('new-energy-maintenance')}}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <fieldset class="form-group">
                                ...
                                <select name="maintenance_new_electricity_action_id" class="form-control">
                                    <option disabled selected>Choose one...</option>
                                    @foreach($maintenanceEnergyActions as $maintenanceEnergyAction)
                                    <option value="{{$maintenanceEnergyAction->id}}">
                                        {{$maintenanceEnergyAction->maintenance_action_new_electricity}}
                                    </option>
                                    @endforeach
                                </select>
                            </fieldset>
