...
<p>
    <button class="btn btn-primary" type="button" data-toggle="collapse" 
        data-target="#collapseEnergyCometExport" aria-expanded="false" 
        aria-controls="collapseEnergyCometExport">
        <i class="menu-icon tf-icons bx bx-export"></i>
        Export Data
    </button>
</p>

<div class="collapse multi-collapse mb-4" id="collapseEnergyCometExport">
...
<script type="text/javascript">
    ...
    function DataTableContent() {
        ...
        table = $('.data-table-energy-comet-meters').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
    ...
    $(function () {
        ...
        $('#clearFiltersButton').on('click', function() {
            ...
            if ($.fn.DataTable.isDataTable('.data-table-energy-comet-meters')) {
                $('.data-table-energy-comet-meters').DataTable().destroy();
            }
            DataTableContent();
        });
