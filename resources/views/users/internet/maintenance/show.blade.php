...
<div id="viewInternetMaintenanceModal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">
                    <span id="internetMaintenanceModalTitle"></span> Details
                </h1>
                                        ...
                                        <div class="col-lg-6">
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                                                    <i id="internetHolderIcon"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Internet Holder</small>
                                                        <h6 class="mb-0" id="englishNameInternetHolder"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                                    <i class="bx bx-calendar bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Start Contract Date</small>
                                                        <h6 class="mb-0" id="dateInternetHolder"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="communityInternetHolder"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                                                    <i class="bx bx-timer bx-sm me-3"></i>
                                                    <div class="ps-3 border-start">
                                                        <small class="text-muted mb-1">Is Expire</small>
                                                        <h6 class="mb-0" id="expireInternetHolder"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-warning mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="callDateInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-primary mb-3">
                                                ...
                                                <li class="d-flex justify-content-start align-items-center text-info mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="completedDateInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="d-flex justify-content-start align-items-center text-success mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="typeInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-light mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="statusInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-dark mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="userInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                                <li class="d-flex justify-content-start align-items-center text-danger mb-3">
                                                    ...
                                                    <div class="ps-3 border-start">
                                                        ...
                                                        <h6 class="mb-0" id="performedInternetMaintenance"></h6>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
